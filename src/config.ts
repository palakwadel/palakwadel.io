export const siteConfig = {
  name: "Palak Wadel",
  title: "Senior Technology Consultant - AI & Data Analytics",
  description: "Portfolio website of Palak Wadel",
  accentColor: "#333333", // dark gray
  social: {
  ...
  aboutMe: `
I’m Palak Wadel, a professional in data analytics and technology solutions with a passion for bridging analytics, AI, and business strategy. 
I specialize in designing intelligent reporting systems that turn complex data into actionable insights. 
  ...
  projects: [
    {
      ...
      description:
        "Collaborated on the rollout of WolfGPT, an internal AI assistant enabling business users to query enterprise data using natural language. Contributed to defining metadata mappings, testing query accuracy, and integrating LLM outputs with Snowflake datasets for contextual insights.",
      link: "", // removed
